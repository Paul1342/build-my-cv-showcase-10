...
const CVBuilder = () => {
  ...
  // Calculate responsive scale for preview
  useEffect(() => {
    const calculateScale = () => {
      ...
      const cvWidth = 794; // Fixed CV width
      
      // Only scale down if container is smaller than CV width
  ...
  const handleTemplateSelect = (templateId: string) => {
    ...
    // Load placeholder data for editing mode
    setCvData(placeholderData);
    // Reset edited fields tracker
    setEditedFields({});
    // Set initial color based on template default
